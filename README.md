### Hi there, I'm Jeevak 👋
**Data Scientist | Machine Learning | MLOps Orchestration**

I transition enterprise data into production-grade infrastructure. I specialize in building predictive machine learning models, designing actionable data analytics pipelines, and orchestrating agentic AI workflows to automate complex backend deployments.

**🛠️ Tech Stack & Capabilities** 
*   **AI & Orchestration:** Google Antigravity SDK, Claude Code, Agentic Workflows, Prompt Engineering
*   **Data Science & ML:** Python, SQL, Scikit-learn, TensorFlow, Pandas, Tableau
*   **Infrastructure & Backend:** Docker, GitHub Actions (CI/CD), Linux, PostgreSQL, Flask
